                                ...
                                <table class="table table-centered table-nowrap mb-0 table-bordered">
                                    ...
                                    @foreach($categories as $category)
                                        <tr>
                                            ...
                                            <td><!-- Button trigger modal --><button type="button" class="btn btn-primary btn-sm btn-rounded waves-effect waves-light" data-toggle="modal" data-target=".exampleModal{{ $category->id }}">Edit</button></td>
                                        </tr>
